...
### Bonus
We can use `tbl_regression()` to create a nice regression table for the logistic regression model, similar to what we did for the linear regression model. This will provide a more user-friendly summary of the results.
